...
/* Source:   id:000061,src:000004+000056,time:121,execs:11726,op:splice,rep:3 */
...
int main(void) {
    ...
    treetable_add(t, &(int32_t){336860180}, &(int32_t){-1717987052});
    ...
    treetable_get_greater_than(t, &(int32_t){791624751}, &kp);
