/* id_000317_src_000003+000308_time_556952_execs_11299655_op_splice_rep_51.c
...
void test(void) {
    ...
    { void *vp; treetable_get(t, &(int32_t){1429679405}, &vp); }
    ...
    treetable_add(t, &(int32_t){-1476335384}, &(int32_t){1465734999});
