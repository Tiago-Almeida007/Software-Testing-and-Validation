/* id_000226_src_000003+000206_time_671_execs_26622_op_splice_rep_2.c
...
void test(void) {
    ...
    { void *vp; treetable_get(t, &(int32_t){-943212033}, &vp); }
    ...
    treetable_add(t, &(int32_t){-2088533247}, &(int32_t){-2088533117});
